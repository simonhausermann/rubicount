      ...
      _createClass(Tab1Page, [{
        ...
        value: function addTimeToResults() {
          ...
          */
          ...
          this.storage.set('timeAr', this.timesAr); //this.elapsedTime
        }
      }, {
        key: "refreshBestTime",
        ...
        key: "storeAllValues",
        value: function storeAllValues() {// this.storage.set('name', 'Max');
        }
      }, {
        key: "runTimer",
        value: function runTimer() {
          ...
          this.overallTimer = setInterval(function () {
            ...
            _this.elapsed.m = Math.floor(_this.elapsedTime % (1000 * 60 * 60) / (1000 * 60));
            _this.elapsed.s = Math.floor(_this.elapsedTime % (1000 * 60) / 1000);
            _this.elapsed.hs = Math.floor(_this.elapsedTime % 1000 / 10);
            ...
            _this.elapsed.hs = _this.pad(_this.elapsed.hs, 2);
          }, 10);
        }
      }, {
        key: "pad",
        ...
        key: "updateMyDate",
        value: function updateMyDate($event) {
