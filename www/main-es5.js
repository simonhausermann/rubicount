...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | tab3-export-export-module */
        [__webpack_require__.e("common"), __webpack_require__.e("tab3-export-export-module")]).then(__webpack_require__.bind(null,
        /*! ./tab3/export/export.module */
        "./src/app/tab3/export/export.module.ts")).then(function (m) {
