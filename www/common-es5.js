...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppServicesFormatTimeServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FormatTimeService", function () {
      return FormatTimeService;
    });
    /* harmony import */
    ...
    var FormatTimeService = /*#__PURE__*/function () {
      function FormatTimeService() {
        _classCallCheck(this, FormatTimeService);
      }

      _createClass(FormatTimeService, [{
        key: "formateTime",
        value: function formateTime(timeInMs) {
        ...
        value: function formatDate(timestamp) {
          if (!isNaN(timestamp)) {
            ...
            var date = new Date(timestamp); // Hours part from the timestamp

            var day = date.getDay(); // Minutes part from the timestamp

            var month = "0" + date.getMonth(); // Seconds part from the timestamp

            var year = "0" + date.getFullYear(); // Will display time in 10:30:23 format
    ...
    FormatTimeService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], FormatTimeService);
    /***/
  }
}]);
