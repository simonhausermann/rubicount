...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tabs-tabs-module"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppTabsTabsPageHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<ion-tabs>\n\n  <ion-tab-bar slot=\"bottom\">\n    <ion-tab-button tab=\"tab1\">\n      <ion-icon name=\"stopwatch-outline\"></ion-icon>\n      <ion-label>{{ 'TABS.btnTimer' | translate }}</ion-label>\n    </ion-tab-button>\n\n    <ion-tab-button tab=\"tab2\">\n      <ion-icon name=\"analytics-outline\"></ion-icon>\n      <ion-label>{{ 'TABS.btnStatistics' | translate }}</ion-label>\n    </ion-tab-button>\n\n    <ion-tab-button tab=\"tab3\">\n      <ion-icon name=\"list-outline\"></ion-icon>\n      <ion-label>{{ 'TABS.btnTimes' | translate }}</ion-label>\n    </ion-tab-button>\n    \n    <ion-tab-button tab=\"tab4\">\n      <ion-icon name=\"people-outline\"></ion-icon>\n      <ion-label>{{ 'TABS.btnUsers' | translate }}</ion-label>\n    </ion-tab-button>\n\n</ion-tab-bar>\n\n</ion-tabs>\n";
    /***/
  },
  ...
  function srcAppTabsTabsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Device = _capacitor_core__WEBPACK_IMPORTED_MODULE_3__["Plugins"].Device;

    var TabsPage = function TabsPage(translate) {
      var _this2 = this;
      ...
      if (!this.userObject || !this.userObject.hasOwnProperty('userName')) {
        ...
        Device.getLanguageCode().then(function (lang) {
          var langAr = lang.value.split('-');
          var deviceLang = langAr[0];

          if (_this2.translate.langs.find(function (element) {
            return element == deviceLang;
          })) {
            _this2.userObject.language = deviceLang;
          }

          _this2.actualUser = _this2.userObject.userName;

          _this2.userList.push({
            userName: _this2.actualUser,
            language: _this2.userObject.language
          });

          localStorage.setItem('actualUser', _this2.actualUser);
          localStorage.setItem(_this2.actualUser, JSON.stringify(_this2.userObject));
          localStorage.setItem('userList', JSON.stringify(_this2.userList));
        });
      }
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"]])], TabsPage);
    /***/
  }
}]);
